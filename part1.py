...
class Config:
    def __init__(self, vocab_size):
        ...
        self.block_size = 256   # ek baar mein kitne characters dekhega
        self.n_layer = 6        # kitne transformer blocks
        self.n_head = 6         # attention heads
        self.n_embd = 384       # har token ka vector size
        self.dropout = 0.1
